...
:::{.callout-note}
Spades is much more memory intensive compared to megahit, which is why for this tutorial we **WILL NOT** run it. However, feel free to test it afterwards.
:::
...
Run metaspades, view the content of the generated files and check how many contigs we have.
